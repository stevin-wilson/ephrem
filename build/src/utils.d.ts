 ...
 */
export declare const removePunctuation: (input: string) => string;
export declare const normalizeBookName: (bookName: string) => string;
export declare const normalizeLanguage: (language: string) => string | never;
export declare const isIso6933Code: (language: string) => boolean;
export declare const getValidLanguages: (languages: string[]) => string[];
