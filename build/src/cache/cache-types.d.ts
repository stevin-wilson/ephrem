import { FetchOptions, PassageAndFumsResponse, PassageOptions } from '../api-bible/api-types.js';
...
export declare class BibleNotAvailableError extends Error {
    context: GetBibleIdOptions;
    constructor(context: GetBibleIdOptions);
}
export {};
